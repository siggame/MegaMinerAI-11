...
#    print [species.season for species in self.objects.species]
  ...
  def status(self, connection):
    ...
    typeLists.append(["Fish"] + [i.toList() for i in self.objects.values() if i.__class__ is Fish and (i.isVisible is not 100 or i.owner is self.playerID or connection.type != "player")])
